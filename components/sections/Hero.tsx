        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-100">
              {/* Glow de fondo */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-500/40 to-indigo-600/40 blur-xl scale-110" />
              {/* Marco */}
              <div className="relative w-full h-full rounded-2xl border-2 border-blue-400/50 overflow-hidden bg-black/30 backdrop-blur-sm shadow-2xl">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/imagen-hero.jpeg"
                  alt="Tomás Ninán — Pixel Art"
